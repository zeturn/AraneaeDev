...
func (a *App) setupRoutes() {
	...
	api.Get("/nodes/discover/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.discoverNodes)
	api.Post("/nodes/register/", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.registerNode)
	api.Get("/nodes/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.listNodes)
	api.Get("/nodes", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.listNodes)
	api.Get("/nodes/:id/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNode)
	api.Get("/nodes/:id", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNode)
	api.Put("/nodes/:id/", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.updateNode)
	api.Put("/nodes/:id", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.updateNode)
	api.Delete("/nodes/:id/", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.deleteNode)
	api.Delete("/nodes/:id", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.deleteNode)
	api.Get("/nodes/:id/status/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeStatus)
	api.Get("/nodes/:id/status", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeStatus)
	api.Get("/nodes/:id/capabilities/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeCapabilities)
	api.Get("/nodes/:id/capabilities", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeCapabilities)
	api.Post("/nodes/:id/refresh_capabilities/", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.refreshNodeCapabilities)
	api.Post("/nodes/:id/refresh_capabilities", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.refreshNodeCapabilities)
	api.Get("/nodes/:id/installers/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeInstallers)
	api.Get("/nodes/:id/installers", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getNodeInstallers)
	api.Post("/nodes/:id/install_runtime/", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.installRuntime)
	api.Post("/nodes/:id/install_runtime", a.requireRoles("admin"), a.requireAppScope("araneae.write"), a.installRuntime)
	api.Get("/nodes/:id/install_status/:jobID/", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getInstallStatus)
	api.Get("/nodes/:id/install_status/:jobID", a.requireRoles("admin"), a.requireAppScope("araneae.read"), a.getInstallStatus)
