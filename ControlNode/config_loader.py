...
def _dotenv_paths() -> list[Path]:
    ...
    return [
        ...
        here.parents[1] / ".env",         # ControlNode/.env
    ]
...
def _candidate_paths() -> list[Path]:
    ...
    # repo root (two levels up from this file): ControlNode/ -> repo root
...
def load_config() -> Dict[str, Any]:
    ...
    for p in _candidate_paths():
        try:
            ...
            # Silently ignore malformed config; caller can handle defaults
            return {}
    return {}
